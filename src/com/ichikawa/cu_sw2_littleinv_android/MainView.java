package com.ichikawa.cu_sw2_littleinv_android;

import gameLogic.GameContainer;
import ichikawa.littleInv_Android.GameLogic.Android_GameContainer;
...
public class MainView extends SurfaceView implements SurfaceHolder.Callback,
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		gc =  new Android_GameContainer(this.getWidth(), this.getHeight());	
